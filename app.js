...
app.post('/addNewTransaction',Transactions.addNewTransaction);
app.get('/getAllTransactions',Transactions.getAllTransactions);
app.post('/updateTransaction',Transactions.updateTransaction);
app.listen(port,()=>{
